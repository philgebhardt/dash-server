...
public class NameFactory {
    ...
    public static String newName() {
        return String.format("%s %s", adjectives[random.nextInt(adjectives.length)], names[random.nextInt(names.length)]);
    }
    ...
    private static String[] adjectives = new String[] {"admiring",
            "adoring",
            "agitated",
            "amazing",
            "angry",
